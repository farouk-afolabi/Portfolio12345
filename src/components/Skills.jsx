...
const Skills = () => {
  const skills = {
    ...
    'Backend': ['Node.js', 'Express', 'REST APIs', 'JWT Auth', 'Firebase', 'PHP'],
    'Databases': ['MongoDB Atlas', 'Mongoose', 'Firebase Firestore', 'SQL'],
    'DevOps': ['Docker', 'GitHub Actions', 'Render', 'GitHub Pages', 'Vercel'],
